...
<body>
        ...
        <div class="container">
            <nav class="nav">
                ...
                <ul class="nav__list">
                    ...
                    <li class="nav__list-item"><a href="#">історія</a></li>
    ...
    <div class="main">
        <section class="history" id="history">
            <div class="container">
                <h2 class="history__title">Коротка історія виникнення екскурсії</h2>
                @foreach($stories as $story)
                <div class="history__content">
                    <img src="{{asset($story->story_img)}}" alt="">
                    <div class="history__text">
                        <p class="history__text_description">{{$story->story_text}}</p>
                    </div>
                </div>
                @endforeach
            </div>
